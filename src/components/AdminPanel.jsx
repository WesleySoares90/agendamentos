                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      if (newAppointmentData.date && profId) {
                        checkAvailableSlotsForModal(newAppointmentData.date, profId);
                      }
                    }}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (dateValue && newAppointmentData.professionalId) {
                        checkAvailableSlotsForModal(dateValue, newAppointmentData.professionalId);
                      }
                    }}
